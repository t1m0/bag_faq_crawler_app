...
class TestBagFaqCrawler(unittest.TestCase):
    ...
    def test_answer_changed_of_existing_node(self):
        ...
        self.watson_wrapper.update_dialog_node.assert_called_with('test', 'question (BAG)', 'answer2 ...' + self.find_more_link, 'faq')
    ...
    def test_question_changed_of_existing_node(self):
        ...
        self.watson_wrapper.update_dialog_node.assert_called_with('test', 'question2 (BAG)', 'answer ...' + self.find_more_link,'faq')
